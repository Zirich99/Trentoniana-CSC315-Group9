...
-- create admin accts
\copy admin (a_username, a_password)
FROM 'home/lion/Downloads/app/stage-v-group-9/app/ADMIN - Sheet1.csv'
DELIMITER ','
CSV HEADER;

-- create editor accts
\copy editor (e_username, e_password, a_username)
FROM 'home/lion/Downloads/app/stage-v-group-9/app/EDITOR - Sheet1.csv'
DELIMITER ','
CSV HEADER;

-- create categories
\copy category(c_name)
FROM 'home/lion/Downloads/app/stage-v-group-9/app/CATEGORY - Sheet1.csv'
DELIMITER ','
CSV HEADER;

-- create audiofile records
\copy audiofile (audiofile_id, audio_filename, upload_date, e_username)
FROM 'home/lion/Downloads/app/stage-v-group-9/app/AUDIOFILE - Sheet1.csv'
DELIMITER ','
CSV HEADER;

-- create participants 
\copy participant(p_id, fullname, e_username)
FROM 'home/lion/Downloads/app/stage-v-group-9/app/PARTICIPANT - Sheet1.csv'
DELIMITER ','
CSV HEADER;

-- create audio records
\copy audio (audio_id, audiofile_id, date_of_recording, p_id, e_username)
FROM 'home/lion/Downloads/app/stage-v-group-9/app/AUDIO - Sheet1.csv'
DELIMITER ','
CSV HEADER;

-- create transcribers
\copy transcriber (t_id, fullname, e_username)
FROM 'home/lion/Downloads/app/stage-v-group-9/app/TRANSCRIBER - Sheet1.csv'
DELIMITER ','
CSV HEADER;

-- create transcriptfile records
\copy transcriptfile (transcriptfile_id, transcript_filename, upload_date, e_username)
FROM 'home/lion/Downloads/app/stage-v-group-9/app/TRANSCRIPTFILE - Sheet1.csv'
DELIMITER ','
CSV HEADER;

-- create transcript records
\copy transcript (transcript_id, transcriptfile_id, date_of_transcription, t_id, e_username)
FROM 'home/lion/Downloads/app/stage-v-group-9/app/TRANSCRIPT - Sheet1.csv'
DELIMITER ','
CSV HEADER;

-- create entries
\copy entry (entry_id, entry_name, audio_id, transcript_id, c_name, e_username)
FROM 'home/lion/Downloads/app/stage-v-group-9/app/ENTRY - Sheet1.csv'
DELIMITER ','
CSV HEADER;
